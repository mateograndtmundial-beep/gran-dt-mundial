...
| [`MONETIZACION.md`](./MONETIZACION.md) | **Doc único de la Liga Premium**: propuesta, decisiones de negocio, modelo económico, riesgos, **checklist para salir LIVE** y **plan de la UI de inscripción**. El cobro en Mercado Pago aparece como "GOLDEN TICKET". | Vas a tocar la feature de ligas premium: negocio, qué falta para activarla, o el front de inscripción. |
