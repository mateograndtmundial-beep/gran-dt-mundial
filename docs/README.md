...
| [`MONETIZACION.md`](./MONETIZACION.md) | Copa GOLDEN TICKET (ligas premium): propuesta, decisiones de negocio, modelo económico, riesgos. | Vas a tocar la feature de ligas premium / monetización por copas. |
| [`COPA-CHECKLIST.md`](./COPA-CHECKLIST.md) | **Archivo guía de la Copa GOLDEN TICKET**: estado, decisiones cerradas y checklist de lo que falta (legal, fiscal, técnico, marketing) para salir live. | Querés saber qué falta para activar la Copa o en qué seguir. |
| [`COPA-UI-INSCRIPCION-PLAN.md`](./COPA-UI-INSCRIPCION-PLAN.md) | Plan de la UI de inscripción a la Copa (scaffold sin construir): superficies, componentes, datos ya disponibles. | Vas a implementar el front de la Copa. |
