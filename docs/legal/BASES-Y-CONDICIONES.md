# Bases y Condiciones — Liga Premium

> **DRAFT — [REVISAR CON ABOGADO antes de publicar y cobrar].** Este documento es la base
> de trabajo del texto legal de la Liga Premium. Lo marcado con `[REVISAR CON ABOGADO]`
> depende del visto profesional (encuadre legal/fiscal del cobro de entrada + premio en
> dinero). El contenido vive también, en versión usuario, en `app/bases/page.tsx`
> (mantener ambos en sync). Última actualización: 20/06/2026.

## 1. Organizador
La **Liga Premium** es una competencia organizada por **Los 11 de Sampa** (los11desampa.com),
dentro del juego de fantasy football del Mundial FIFA 2026. Consultas y soporte: por el canal
de soporte del sitio (`/soporte` → Instagram [@los11desampa](https://www.instagram.com/los11desampa/)
...
La Liga Premium **no cambia las reglas del juego**: se compite con el mismo equipo, bajo las
mismas reglas que el resto del torneo. En resumen:

- **Plantel:** 15 jugadores (**11 titulares + 4 suplentes**) más **1 director técnico (DT)**,
  armado dentro de un **presupuesto de 700**. Cada jugador y el DT tienen un precio.
- **Capitán:** elegís un capitán entre los titulares; **duplica su puntaje base** (no los bonos).
- **Formaciones:** se juega con formaciones de tres líneas (4-4-2, 4-3-3, 4-2-4, 3-4-3, 3-3-4),
  siempre con 11 titulares.
- **Jugadores por país (tope por selección):**
  - **Fase de grupos:** máximo **3 jugadores por país**.
  - **Desde los 16vos de final (playoffs):** máximo **5 jugadores por país**. Es una regla
    **general del juego** (vale para todos los usuarios, no solo la Liga Premium); como la Liga
    Premium se juega desde 16vos, el tope aplicable es **5 por país**.
- **Cambios entre fechas:** ver punto 4.
...
dependa de la cantidad de inscriptos: se reparte sí o sí). Se distribuye entre los **10 primeros**
del ranking final de la copa:
...
## 7. Desempate
Si dos o más equipos terminan con los **mismos puntos totales**, el orden se define por:
1. **Mejor puntaje obtenido en una sola fecha** dentro de la Liga Premium (de 16vos en adelante);
2. si persiste el empate, la **inscripción más temprana** (orden de pago).

## 8. Momento de corte del ranking
El ranking se considera **final y oficial** una vez **publicados los puntos de la Final** del
Mundial. Ese es el estado que se usa para determinar los 10 premiados; los cambios o
...
al organizador (decisiones de FIFA, fuerza mayor, etc.), la Liga Premium se **adecúa de forma
razonable** a la nueva situación. Si resultara **imposible** determinar un ranking final por esas
causas, el organizador podrá definir una **alternativa equitativa** (por ejemplo, cortar el
...
**transferencia bancaria** a un **CBU/ALIAS de una cuenta bancaria argentina** (no se paga a
cuentas del exterior ni por otros medios). Para cobrar, el ganador deberá **comunicarse con el
organizador** dentro de la ventana de reclamo y **acreditar su identidad**: se le pedirá demostrar
acceso al **correo electrónico registrado en la cuenta** con la que jugó, para confirmar que es el
titular legítimo. El CBU/ALIAS debe corresponder a una cuenta a su nombre. `[REVISAR CON ABOGADO:
ventana de reclamo, validación de titularidad, retención de impuestos si corresponde]`

## 13. Privacidad y uso de imagen
Al inscribirte **aceptás que, en caso de resultar ganador, se publique tu nombre de usuario (y/o
nombre) en las redes y comunicaciones del juego** a efectos de anunciar resultados. El tratamiento
general de tus datos se rige por la [Política de Privacidad](/privacidad).

## 14. Conducta y descalificaciones
El organizador podrá descalificar cuentas que incurran en fraude, multicuenta, o cualquier maniobra
que vulnere la mecánica del juego o estas bases. Una cuenta descalificada **pierde el derecho al
premio**; `[REVISAR CON ABOGADO: si corresponde reembolso de la entrada en caso de descalificación]`.

## 15. Modificación de las bases
El organizador podrá **actualizar estas bases** (por ejemplo, para aclarar reglas o corregir
errores). Los cambios se publican en esta página con su **fecha de última actualización**. Los
