...
| [`HIGHLIGHTS.md`](./HIGHLIGHTS.md) | **Destacadas** (Instagram Highlights): los 4 packs de stories 9:16 evergreen (Empezá acá, Puntaje, La Copa, Gratis y amigos) + las tapas circulares (FAQ y resultados F1…Final). Comandos, tapas y reglas de zona segura. | Vas a generar/actualizar las destacadas del perfil. |
...
| [`LANZAMIENTO-COPA.md`](./LANZAMIENTO-COPA.md) | **Plan de comunicación del lanzamiento de la Liga Premium**: ángulo "prode pero en serio", cadencia, stories, budget escalonado ($100k por copa), IG vs X, calendario día por día y anatomía de cada pieza. Incluye el **anexo con las 9 publicaciones de IG** (21/06→28/06; el lanzamiento se corrió un día, así que el **22/06 lleva 2 carruseles**), una por una (copy, objetivo y por qué). | Vas a comunicar/promocionar la Liga Premium o redactar/subir los posts del lanzamiento. |
