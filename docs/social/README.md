...
| [`LANZAMIENTO-COPA.md`](./LANZAMIENTO-COPA.md) | **Plan de comunicación del lanzamiento de la Copa GOLDEN TICKET**: ángulo "prode pero en serio", cadencia, stories, budget escalonado ($100k por copa), IG vs X, calendario día por día y anatomía de cada pieza. | Vas a comunicar/promocionar la Copa en redes. |
